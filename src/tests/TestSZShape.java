...
import api.Position;
import api.Shape;
import shapes.SZShape;

public class TestSZShape
{
	private SZShape shape;
	private Position position;
	private Block genericBlock = new Block(Color.GREEN);
	private Block magicBlock = new Block(Color.GREEN, true);
