...
/**
 * Sample test code for Shape rotation, shift, and cycle. The comments in the
 * code below specifically refer to testing the LShape, but you can adapt the
 * code to test any shape.
 */
public class ExampleShapeTests
{
	/**
	 * Helper method to create a shape at the given position for testing. EDIT THIS
	 * CODE FOR THE SHAPE YOU WANT TO TEST.
	 */
